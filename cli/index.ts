...
let cli = yargs(args)
  ...
  .example("$0 mail count \"from:bactolac.com newer_than:1y\"", "Get Gmail's estimated query count")
  .example("$0 mail corpus --from-export=./exports --out-dir=./corpus", "Build an LLM-oriented corpus from exported mail")
